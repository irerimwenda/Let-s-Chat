...
import com.example.ireribrian.firebasechatapp.core.registration.RegisterContract;
import com.example.ireribrian.firebasechatapp.core.registration.RegisterPresenter;
import com.example.ireribrian.firebasechatapp.core.users.add.AddUserContract;
import com.example.ireribrian.firebasechatapp.core.users.add.AddUserPresenter;
import com.example.ireribrian.firebasechatapp.ui.activities.UserListingActivity;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    public void onRegistrationSuccess(FirebaseUser firebaseUser) {
        mProgressDialog.setMessage("Ading User to db");
